...
const initialMenuItems: MenuItem[] = [
    ...
    { id: 2, name: '치즈 떡볶이', price: '12,000원', description: '2인 떡볶이+모짜렐라치즈+만두튀김' },
    { id: 3, name: '로제 떡볶이', price: '13,500원', description: '2인 로제떡볶이+베이컨+소세지' },
    { id: 4, name: '라볶이', price: '13,000원', description: '2인 떡볶이+라면사리+계란' },
    { id: 5, name: '짜장 떡볶이', price: '13,000원', description: '2인 짜장떡볶이+어묵' },
];
